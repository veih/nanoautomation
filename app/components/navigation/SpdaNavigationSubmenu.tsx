...
interface SpdaNavigationSubmenuProps {
  isCollapsed: boolean; // Para controlar a visibilidade e estilo quando o sidebar está colapsado
}

const SpdaNavigationSubmenu: React.FC<SpdaNavigationSubmenuProps> = ({
  isCollapsed,
}) => {
  ...
  return (
    <div
      className={`spda-submenu bg-primary rounded-3 shadow-sm ${
    ...
    >
      ...
      >
        {/* Categoria SPDA - Item de menu horizontal */}
        <li className="nav-item me-0 me-md-2 mb-1">
          {/* Sub-submenu de SPDA - Também horizontal, aninhado e com indentação */}
          <ul
          ...
          >
            ...
            <li className="nav-item me-0 me-md-2 mb-1">
              <Link
                ...
                className={getLinkClasses("/dashboard/dashboardScp")}
              >
                {!isCollapsed && "Dashboard SCP"}
              </Link>
            </li>
...
export default SpdaNavigationSubmenu;
